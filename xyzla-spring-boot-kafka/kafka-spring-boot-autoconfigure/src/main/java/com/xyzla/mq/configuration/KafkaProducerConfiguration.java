...
public class KafkaProducerConfiguration {
    ...
    public KafkaProducer<String, String> kafkaProducer() {
        ...
        logger.info("kafka.consumer.enabled: {}", kafkaContext.getConsumerEnabled());
        logger.info("kafka.producer.enabled: {}", kafkaContext.getProducerEnabled());
        return producer;
    }

    @Bean
    @DependsOn("kafkaProducer")
    public Producer producer(@Qualifier("kafkaProducer") KafkaProducer kafkaProducer) {
