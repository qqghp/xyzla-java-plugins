...
public class MailValid {
    ...
    public static void main(String[] args) {
        System.out.println(new MailValid().valid("xqghp@126.com", "aliyun.com"));
//        DNSLookupUtil.getMXRecord("showmac.com");
    }
    ...
    public boolean valid(String toMail, String domain) {
        ...
        if (!StringUtils.hasText(toMail) || !StringUtils.hasText(domain)) {
            return false;
        }
        if (!toMail.contains("@")) {
            return false;
